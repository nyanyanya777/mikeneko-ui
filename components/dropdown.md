...
<div class="relative inline-block">
  <button
    ...
    class="inline-flex items-center gap-2 bg-white text-slate-700 border border-slate-200 px-4 py-2 rounded-lg text-base font-medium hover:bg-gray-50 transition-colors">
    オプション
