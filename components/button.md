...
| Medium | カード/ダイアログ内の主要アクション | `px-4 py-2 text-base` | 18px |
| Small | カードフッター・リスト内など省スペース | `px-3 py-1.5 text-[0.875rem]` | 14px |

> Medium と Large はフォントサイズ共通（18px = `text-base`）。パディング差（`py-2` vs `py-2.5`、`px-4` vs `px-5`）で視覚的階層を区別する。入力欄（`text-base py-2`）と同じ行に配置しても高さが揃う。
...
```html
<button class="inline-flex items-center justify-center gap-2 px-4 py-2 text-base font-medium text-white bg-primary-600 rounded-lg hover:bg-primary-700 active:bg-primary-800 focus:outline-none focus:ring-2 focus:ring-primary-500/50 transition-colors">
  保存する
</button>
```
...
```html
<button class="inline-flex items-center justify-center gap-2 px-4 py-2 text-base font-medium text-primary-600 bg-white border border-primary-600 rounded-lg hover:bg-primary-50 active:bg-primary-100 focus:outline-none focus:ring-2 focus:ring-primary-500/50 transition-colors">
  フォロー
</button>
```
...
```html
<button class="inline-flex items-center justify-center gap-2 px-4 py-2 text-base font-medium text-slate-700 bg-white border border-slate-200 rounded-lg hover:bg-gray-50 active:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-primary-500/50 transition-colors">
  戻る
</button>
```
...
```html
<button class="inline-flex items-center justify-center gap-2 px-4 py-2 text-base font-medium text-white bg-red-500 rounded-lg hover:bg-red-600 active:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500/50 transition-colors">
  削除する
</button>
```
...
```html
<button class="inline-flex items-center justify-center gap-2 px-4 py-2 text-base font-medium text-body rounded-lg hover:bg-gray-100 active:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-primary-500/50 transition-colors">
  キャンセル
</button>
```
...
```html
<button disabled class="inline-flex items-center justify-center gap-2 px-4 py-2 text-base font-medium text-white bg-primary-600 rounded-lg opacity-50 cursor-not-allowed">
  保存する
</button>
```
...
```html
<button disabled class="inline-flex items-center justify-center gap-2 px-4 py-2 text-base font-medium text-white bg-primary-600 rounded-lg opacity-75 cursor-not-allowed">
...
<div class="flex justify-end gap-3">
  ...
  <button class="px-4 py-2 text-base font-medium text-body rounded-lg hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-primary-500/50 transition-colors">
    キャンセル
  </button>
  <button class="px-4 py-2 text-base font-medium text-white bg-primary-600 rounded-lg hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-primary-500/50 transition-colors">
    確認する
  </button>
</div>
```
