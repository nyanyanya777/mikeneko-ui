...
```html
<button class="inline-flex items-center justify-center gap-2 h-10 px-4 text-[1rem] font-medium text-white bg-primary-600 rounded-lg hover:bg-primary-700 active:bg-primary-800 focus:outline-none focus:ring-2 focus:ring-primary-500/50 transition-colors">
  保存する
</button>
```
...
```html
<button class="inline-flex items-center justify-center gap-2 h-10 px-4 text-[1rem] font-medium text-primary-600 bg-white border border-primary-600 rounded-lg hover:bg-primary-50 active:bg-primary-100 focus:outline-none focus:ring-2 focus:ring-primary-500/50 transition-colors">
  フォロー
</button>
```
...
```html
<!-- Large (48px) -->
<button class="inline-flex items-center justify-center gap-2 h-12 px-6 text-[1rem] font-medium text-white bg-primary-600 rounded-lg hover:bg-primary-700 active:bg-primary-800 focus:outline-none focus:ring-2 focus:ring-primary-500/50 transition-colors">
  保存する
</button>

<!-- Small (32px) -->
<button class="inline-flex items-center justify-center gap-1.5 h-8 px-3 text-[0.875rem] font-medium text-white bg-primary-600 rounded-lg hover:bg-primary-700 active:bg-primary-800 focus:outline-none focus:ring-2 focus:ring-primary-500/50 transition-colors">
  詳細を見る
</button>
```
...
```html
<!-- Medium — pl-3 pr-4 -->
<button class="inline-flex items-center justify-center gap-2 h-10 pl-3 pr-4 text-[1rem] font-medium text-white bg-primary-600 rounded-lg hover:bg-primary-700 active:bg-primary-800 focus:outline-none focus:ring-2 focus:ring-primary-500/50 transition-colors">
...
```html
<button disabled class="inline-flex items-center justify-center gap-2 h-10 px-4 text-[1rem] font-medium text-white bg-primary-600 rounded-lg opacity-50 cursor-not-allowed">
  保存する
</button>
```
...
```html
<button disabled class="inline-flex items-center justify-center gap-2 h-10 px-4 text-[1rem] font-medium text-white bg-primary-600 rounded-lg opacity-75 cursor-not-allowed">
...
<div class="flex justify-end gap-3">
  ...
  <button class="inline-flex items-center justify-center h-10 px-4 text-[1rem] font-medium text-white bg-primary-600 rounded-lg hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-primary-500/50 transition-colors">
    確認する
  </button>
</div>
```
