...
<div class="relative inline-block">
  <button
    ...
    class="inline-flex items-center justify-center gap-2 h-10 px-4 text-[1rem] font-medium text-white bg-primary-600 rounded-lg hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-primary-500/50 transition-colors">
    ボタン
  </button>
