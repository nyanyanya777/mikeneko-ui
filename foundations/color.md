...
| bg-surface-accent | — | `bg-primary-600` | — | `bg-primary-500` |
| bg-surface-accent-subtle | #eff6ff | `bg-primary-50` | — | `bg-primary-500/[.12]` |
...
| text-accent | `text-primary-600` | `text-primary-400` |
...
| text-link | `text-primary-600` | `text-primary-400` |
...
| border-accent | — | `border-primary-600` | — | `border-primary-500` |
...
| アクセント（CTA） | `bg-primary-600 text-white` |
...
> **注意**: ライトモードの色をそのままダークに持ち込まないこと。`-50` 系背景、`-700` 系テキスト、`-200` 系ボーダーはダークモードで機能しない。禁止パターン詳細: `prohibited.md`「カラー」参照
...
|--------|----------|----------|---------------------|------|
| Primary (Blue) | `primary-600` | 信頼・安定・誠実 | "静かだが確実な存在" | CTA・リンク・フォーカスリング |
